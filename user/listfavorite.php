...
<body>
    ...
    <body>
        <nav class="navbar">
            <div class="nav-left"><a href="index.php?act=dangnhap"><img class="logo"
                        src="https://quyhyvong.com/wp-content/uploads/2021/12/Logo-FPT-Synnex.png" alt="Trang chủ"></a>
                <ul class="navlogo">
                    ...
                    <div class="status-field-container write-post-container" data-id="<?= $post['id'];  ?>">
                        ...
                        <div class="post-reaction">
                            ...
                            <div class="post-profile-picture">
                                <img src="<?= "images/" . $post['hinhuser'] ?>" alt=""> <i
